# 動漫角色分析器｜可引用的角色關係與創作研究卡 — 規格計劃書 v2.2.1
...
本版完全重寫，依 2026 sweet spot 5 問體檢：2/10，建議動作為「kill（本次不執行；先驗證再開發）」。
市場不是沒有需求，而是現有競品 trace.moe、Google Lens、AniList、Bangumi 已覆蓋原本寬泛的功能。體檢找到的缺口是：trace.moe 免費做影像辨識，Google Lens 已涵蓋以圖搜圖；目前產品是模擬結果，沒有可信資料來源與創作工作流。泛用「戰力分析」既不可驗證又容易引戰。
...
|---|---|---|---|---|
| Primary | 10 位 pilot | 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。 | 每週固定工作 | 願意提供真實資料並重做 |
| Secondary | 5 位 adjacent | 相鄰工具使用者 | 目前用競品或表格 | 願意切換/匯出 |
| Buyer/Influencer | 3–5 位 | 顧問、主管或校園/社群 | 替他人推薦工具 | 願意安排 demo |

### 1.3 核心價值主張 (Value Proposition)

> 「不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。」
這個主張直接回應 sweet=2：不是複製 trace.moe、Google Lens、AniList、Bangumi 的主功能，而是聚焦「trace.moe 免費做影像辨識，Google Lens 已涵蓋以圖搜圖；目前產品是模擬結果，沒有可信資料來源與創作工作流。泛用「戰力分析」既不可驗證又容易引戰。」所留下的可驗證空間。
...
- ❌ 不做 trace.moe 或 Google Lens 的影像反搜
- ❌ 不做未標來源的 AI 角色猜測
- ❌ 不做官方戰力排名或跨作品勝負裁決
- ❌ 不抓取或提供動畫/漫畫盜版內容
- ❌ 不做社交、同人發布與圖片生成平台
- ❌ sweet=2，先用 10 位創作者驗證引用與匯出，不先建 100 部作品
...
#### US-001：支援 3 部可合法整理的示範作品資料
> As a 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
> I want 支援 3 部可合法整理的示範作品資料
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-002：角色研究卡：別名、陣營、首次出場、關係、來源連結
> As a 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
> I want 角色研究卡：別名、陣營、首次出場、關係、來源連結
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-003：每個欄位顯示 canon/使用者推論/未確認狀態
> As a 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
> I want 每個欄位顯示 canon/使用者推論/未確認狀態
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-004：spoiler level：無雷、輕雷、重雷，預設遮罩
> As a 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
> I want spoiler level：無雷、輕雷、重雷，預設遮罩
> So that 我能在不改變原有工作習慣下完成一個可交付結果。

#### US-005：關係圖只畫已知關係並顯示證據來源
> As a 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
> I want 關係圖只畫已知關係並顯示證據來源
> So that 我能在不改變原有工作習慣下完成一個可交付結果。
...
#### US-007：Markdown/JSON 匯出與文章引用格式
> As a 需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
> I want Markdown/JSON 匯出與文章引用格式
> So that 我能在不改變原有工作習慣下完成一個可交付結果。
...
本 MVP 由 sweet=2 重新定義：只保留「不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。」所需的最短閉環，不做競品已主導的廣泛功能。
#### FR-001：支援 3 部可合法整理的示範作品資料（MUST）
- 目的：將 支援 3 部可合法整理的示範作品資料 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-002：角色研究卡：別名、陣營、首次出場、關係、來源連結（MUST）
- 目的：將 角色研究卡：別名、陣營、首次出場、關係、來源連結 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-003：每個欄位顯示 canon/使用者推論/未確認狀態（MUST）
- 目的：將 每個欄位顯示 canon/使用者推論/未確認狀態 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-004：spoiler level：無雷、輕雷、重雷，預設遮罩（MUST）
- 目的：將 spoiler level：無雷、輕雷、重雷，預設遮罩 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-005：關係圖只畫已知關係並顯示證據來源（MUST）
- 目的：將 關係圖只畫已知關係並顯示證據來源 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-006：使用者筆記與引用段落分離（MUST）
- 目的：將 使用者筆記與引用段落分離 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-007：Markdown/JSON 匯出與文章引用格式（MUST）
- 目的：將 Markdown/JSON 匯出與文章引用格式 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-008：同名角色以作品與語言標識（MUST）
- 目的：將 同名角色以作品與語言標識 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-009：資料修正提案進入本地待審清單（MUST）
- 目的：將 資料修正提案進入本地待審清單 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。

#### FR-010：完全 mock-first，沒有假裝串接外部 AI（MUST）
- 目的：將 完全 mock-first，沒有假裝串接外部 AI 變成可測試的最小行為。
- 輸入：使用者提供的最小必要資料；不得默認補造關鍵事實。
- 輸出：可讀、可修改、可匯出並帶版本/時間戳的結果。
- 失敗：保留草稿、顯示可理解錯誤與下一步。
...
- P1-01 AniList 作品 metadata 單向同步：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-02 創作者共用研究卡：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-03 來源變更 diff：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-04 圖片識別只做「導向 trace.moe」而非重做：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-05 引用模板與 Obsidian/Notion 匯出：只有在 MVP 指標達標且有 3 個以上相同請求時排入。
- P1-06 小型付費資料包：只有在 MVP 指標達標且有 3 個以上相同請求時排入。

### 3.3 v3（探索，P2）

- P2-01 授權資料合作：不承諾時程，需重新檢查競品與合規。
- P2-02 多語言研究卡：不承諾時程，需重新檢查競品與合規。
- P2-03 作者社群審核：不承諾時程，需重新檢查競品與合規。
- P2-04 視覺小說/漫畫擴充：不承諾時程，需重新檢查競品與合規。

### 3.4 ⭐ Acceptance Criteria (Given / When / Then)

**AC-001：首次進入只顯示三部示範作品與資料來源**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「首次進入只顯示三部示範作品與資料來源」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-002：角色卡每個非使用者欄位至少有一個 URL 或「未確認」標記**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「角色卡每個非使用者欄位至少有一個 URL 或「未確認」標記」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-003：spoiler level 變更會即時遮罩重雷文字**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「spoiler level 變更會即時遮罩重雷文字」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-004：關係圖節點點擊可看到關係證據**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「關係圖節點點擊可看到關係證據」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-005：系統不呈現未驗證的戰力數字**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「系統不呈現未驗證的戰力數字」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-006：同名角色搜尋結果清楚顯示作品**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「同名角色搜尋結果清楚顯示作品」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-007：匯出的 Markdown 含來源、更新日期與 spoiler 聲明**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「匯出的 Markdown 含來源、更新日期與 spoiler 聲明」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-008：使用者筆記與 canon 資料在資料模型上分離**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「使用者筆記與 canon 資料在資料模型上分離」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。

**AC-009：外部 API 失敗時示範資料仍可讀**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「外部 API 失敗時示範資料仍可讀」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 若失敗則提供降級路徑，不遺失已輸入資料。

**AC-010：提出修正後能看到 pending 狀態而不直接改公開內容**
- **Given** 使用者進入對應流程且權限有效
- **When** 執行「提出修正後能看到 pending 狀態而不直接改公開內容」
- **Then** 系統產生可驗證結果，並寫入事件時間、版本與錯誤狀態。
- **And** 使用者可檢查、修改或匯出結果，不被黑箱鎖定。
...
|---|---|---|---|---|
| GET | /data/demo-works.json | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| GET | /api/characters/:id | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/research-cards | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/revisions | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/export/markdown | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
| POST | /api/export/json | session/optional | 核心資料操作 | Zod 400；5xx exponential backoff |
...
| 風險 | 等級 | 早期訊號 | 緩解 | 停止/轉向 |
|---|---|---|---|---|
| trace.moe 與 Google Lens 免費且使用者目的不同 | 🔴 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 動漫圖片/IP 授權與資料抓取風險 | 🟠 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 來源不完整造成錯誤引用 | 🟡 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 同人社群對「canon」定義衝突 | 🔴 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 市場太小且付費頻率低 | 🟠 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 目前 mock 結果讓 demo 信任受損 | 🟡 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |
| 作品資料維護成本超過單人能力 | 🔴 | 訪談或監控出現反覆抱怨 | 限制 scope、人工核准、資料刪除與 fallback | 兩個 sprint 未改善即重新 discovery |

### 7.2 ⭐ ADR (Architecture Decision Records)

本節明確記錄 sweet=2 的取捨：競品 trace.moe、Google Lens、AniList、Bangumi 已在原紅海取得優勢，因此每個決策都必須服務於「不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。」。
#### ADR-001
**Decision**：ADR-001：從影像分析改為來源型研究卡；sweet=2 的主要問題是被免費影像搜尋取代。
...
#### ADR-002
**Decision**：ADR-002：取消戰力分數；不可驗證的排名不是可靠價值，改存「使用者觀點」標籤。
**Context**：sweet spot 5 問體檢顯示，追求更寬功能會增加成本而不增加證據。
**Trade-off**：短期可展示功能較少，但能測到真實 job、信任與回購。
**Reversal trigger**：若指定指標未達標，回到 discovery；若達標才允許擴充。

#### ADR-003
**Decision**：ADR-003：只上三部示範作品；先驗證研究卡是否被匯出使用，再擴資料。
**Context**：sweet spot 5 問體檢顯示，追求更寬功能會增加成本而不增加證據。
**Trade-off**：短期可展示功能較少，但能測到真實 job、信任與回購。
**Reversal trigger**：若指定指標未達標，回到 discovery；若達標才允許擴充。

#### ADR-004
**Decision**：ADR-004：canon 與 inference 分表；避免 AI/使用者推論冒充官方事實。
**Context**：sweet spot 5 問體檢顯示，追求更寬功能會增加成本而不增加證據。
**Trade-off**：短期可展示功能較少，但能測到真實 job、信任與回購。
**Reversal trigger**：若指定指標未達標，回到 discovery；若達標才允許擴充。
...
| 方案 | 價格 | 限制/價值 | 觸發升級 |
|---|---|---|---|
| 免費：3 部作品、20 張研究卡 | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
| 創作者包：NT$99/月，無限筆記與引用匯出 | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
| 資料包：單部作品 NT$49（需確認授權） | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
| 不提供 AI 分析訂閱，直到資料品質可驗證 | 見產品頁 | 以本案核心 job、匯出、協作或報表分層 | 完成兩次核心 job 後詢問，而非首次強 paywall |
...
|---|---|---|---|
| trace.moe | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| Google Lens | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| AniList | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| Bangumi | 規模/習慣/通用功能 | 紅海主功能 | 本案 wedge |
| 本專案 | 不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。 | 不承諾全市場 | 需用 §11 證明 |
...
- trace.moe 官方網域在本次 request 回應 403，不能推斷服務下線；原 sweet spot 明確指出其免費替代性。
- Google Lens 已涵蓋以圖搜圖，是影像辨識定位的直接替代。
- 原分析指出目前是模擬結果；本次將「來源與資料狀態」提升到 MVP 驗收，不再用模擬戰力充當功能。
...
本計畫由 sweet=2 與競品 trace.moe、Google Lens、AniList、Bangumi 反推；目的不是證明產品存在，而是證明指定 wedge「不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。」能產生重複行為與付款。
### 11.1 驗證前 3 個關鍵問題

1. **誰在最近 30 天真的遇到這個 job，且目前用什麼替代？**
   - 證據：trace.moe 免費做影像辨識，Google Lens 已涵蓋以圖搜圖；目前產品是模擬結果，沒有可信資料來源與創作工作流。泛用「戰力分析」既不可驗證又容易引戰。
...
**Target 4：4 位有 Obsidian/Notion 研究流程的創作者**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。

**Target 5：5 位普通動漫搜尋者（反需求訪談）**
- 先問最近一次事件，不先展示功能。
- 記錄目前工具、步驟、耗時、錯誤與替代成本。
- 展示一個 5 分鐘 prototype，觀察是否主動完成下一步。
- 結束只問 willingness-to-pay 與願不願提供資料，不引導答案。
...
- 主題：在同人社群發文：「寫角色分析時，你最常回頭找哪一種來源？可引用的資料卡比 AI 戰力分數更有用嗎？」
- 先發問題與匿名結果，不把 landing page 寫成廣告。
- 成功：至少 20 個有情境回覆、5 人願意進 pilot、反對理由可分類。

### 11.4 Landing page test

- 測試：主標 A/B：角色辨識 vs 可引用研究卡；成功事件是匯出一篇含 3 個引用的 Markdown，而不是查詢次數。
...
- **甜蜜點低分規則**：sweet=2 的專案在 No-go 任一項連續兩週成立，標記為 hold/開源，而不是繼續追加功能。
---
...
**MUST（P0）**
- MUST-01 支援 3 部可合法整理的示範作品資料
- MUST-02 角色研究卡：別名、陣營、首次出場、關係、來源連結
- MUST-03 每個欄位顯示 canon/使用者推論/未確認狀態
- MUST-04 spoiler level：無雷、輕雷、重雷，預設遮罩
- MUST-05 關係圖只畫已知關係並顯示證據來源
- MUST-06 使用者筆記與引用段落分離
- MUST-07 Markdown/JSON 匯出與文章引用格式
- MUST-08 同名角色以作品與語言標識
- MUST-09 資料修正提案進入本地待審清單
- MUST-10 完全 mock-first，沒有假裝串接外部 AI

**SHOULD（P1）**
- SHOULD-01 AniList 作品 metadata 單向同步
- SHOULD-02 創作者共用研究卡
- SHOULD-03 來源變更 diff
- SHOULD-04 圖片識別只做「導向 trace.moe」而非重做
- SHOULD-05 引用模板與 Obsidian/Notion 匯出
- SHOULD-06 小型付費資料包
...
- REQ-POOL-001：AniList 作品 metadata 單向同步
- REQ-POOL-002：創作者共用研究卡
- REQ-POOL-003：來源變更 diff
- REQ-POOL-004：圖片識別只做「導向 trace.moe」而非重做
- REQ-POOL-005：引用模板與 Obsidian/Notion 匯出
- REQ-POOL-006：小型付費資料包
- REQ-POOL-007：授權資料合作
- REQ-POOL-008：多語言研究卡
- REQ-POOL-009：作者社群審核
- REQ-POOL-010：視覺小說/漫畫擴充
- REQ-POOL-011：匿名基準資料
- REQ-POOL-012：顧問模式
- REQ-POOL-013：進階匯入
...
**本次結論：sweet spot score = 2/10；recommended action = kill（本次不執行；先驗證再開發）。**
本專案不因原分析標示 kill 而刪除；依使用者要求，本版將低分結果轉成「先驗證再開發」的窄定位。

### 15.1 五問一：誰已經解決了主要問題？

- 主要競品：trace.moe、Google Lens、AniList、Bangumi。
- 競品優勢不是推測，而是公開產品入口、成熟使用習慣或原分析的競品清單。
- 本案決定不追逐其最強維度，改用 wedge：不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。
### 15.2 五問二：使用者為何還會換？

- 已知 gap：trace.moe 免費做影像辨識，Google Lens 已涵蓋以圖搜圖；目前產品是模擬結果，沒有可信資料來源與創作工作流。泛用「戰力分析」既不可驗證又容易引戰。
- 可換理由必須是具體 job 的時間、錯誤、回流或合規成本；「AI 很酷」不算。
- 研究訪談需請使用者展示最近一次原流程，禁止只做偏好問卷。
### 15.3 五問三：甜蜜點是否比競品更窄、更可交付？

- 窄定位：不做影像辨識替代品，改做「研究卡」：對指定作品建立來源、集數、關係與 spoiler 標記，讓同人作者可引用、比較、匯出，而不是生成看似權威的戰力分數。
- MVP 僅包含：支援 3 部可合法整理的示範作品資料；角色研究卡：別名、陣營、首次出場、關係、來源連結；每個欄位顯示 canon/使用者推論/未確認狀態；spoiler level：無雷、輕雷、重雷，預設遮罩；關係圖只畫已知關係並顯示證據來源。
- 排除：不做 trace.moe 或 Google Lens 的影像反搜；不做未標來源的 AI 角色猜測；不做官方戰力排名或跨作品勝負裁決；不抓取或提供動畫/漫畫盜版內容。
- 這是 sweet=2 的直接回應：分數越低，範圍越小、人工驗證越前置。
### 15.4 五問四：誰會付費、用什麼預算？

- 初始付費設計：
  - 免費：3 部作品、20 張研究卡
  - 創作者包：NT$99/月，無限筆記與引用匯出
  - 資料包：單部作品 NT$49（需確認授權）
  - 不提供 AI 分析訂閱，直到資料品質可驗證
...
- 證據：M3 只追求 10 位每週使用研究卡、5 位付費；若沒有人把匯出內容放進公開文章或腳本，停止產品化並保留開源資料格式。
...
- 目標人群：需要整理 1–3 部作品作為同人小說、影片腳本或研究文章素材的繁中創作者；不是只想知道角色名字的一般搜尋者。
- 市場策略：先完成 5 組指定訪談，再用行為漏斗估算可服務市場。
- 不把全球使用者、下載量或競品估值直接乘上採用率。
- 可觸達通路：在同人社群發文：「寫角色分析時，你最常回頭找哪一種來源？可引用的資料卡比 AI 戰力分數更有用嗎？」

### 15.8 收益情境與 unit economics

- M3 只追求 10 位每週使用研究卡、5 位付費；若沒有人把匯出內容放進公開文章或腳本，停止產品化並保留開源資料格式。
...
- **本次 PRD 規格分數：9.5/10（95/100 Notion scale）**。sweet=2 只影響商業化分數，不降低文件是否完整。
- **商業化公式**：`(PRD 9.5 × 0.3 + sweet 2 × 0.7) × 10`。
...
| E-01 | trace.moe 官方網域在本次 request 回應 403，不能推斷服務下線；原 sweet spot 明確指出其免費替代性。 | 對應 §1.1/§3.1/§11 |
| E-02 | Google Lens 已涵蓋以圖搜圖，是影像辨識定位的直接替代。 | 對應 §1.1/§3.1/§11 |
| E-03 | 原分析指出目前是模擬結果；本次將「來源與資料狀態」提升到 MVP 驗收，不再用模擬戰力充當功能。 | 對應 §1.1/§3.1/§11 |
